tickers_crypto = ['BTC-USD', 'ETH-USD', 'BNB-USD', 'SOL-USD',
                  ...
                  'APT21794-USD', 'KAS-USD', 'DOKB-USD', 'FDUSD-USD',
                 ...
                 'Mobile', 'FNSA-USD', 'LPT-USD', 'AUDIO-USD',
                  ...
                  'SFUND-USD', 'FLEX-USD', 'Lab', 'IOST-USD',
                  'JOE-USD', 'LSK-USD', 'ALPH-USD', 'XVS-USD', 'Doge',
                  'USDJ-USD', 'CTC-USD', 'C98-USD', 'BORG-USD', 'Forged',
                  'RLC', 'ARK-USD', 'XYM-USD', 'POWR-USD', 'COTI-USD']
