...
def calculate_total_value(symbols, start_date, end_date):
    ...
    return (total_value - investment_amount), percentage
...
symbols = ['HON', 'OC', 'GFL', 'RHI', 'FCN', 'ADT', 'R', 'JOBY', 'MDT', 'BIIB',
           ...
           'CEIX', 'VTOL', 'VTS', 'NC', 'PNRG', 'SHIB-USD', 'AXS-USD',
           'MANA-USD', 'RVN-USD', 'T-USD', 'ANKR-USD', 'LYX-USD', 'XLRE',
           'EPI', 'EMLP', 'SDOG', 'PID', 'BAB', 'ICF', 'IEO', 'FTXN', 'FXZ',
           'FXG', 'INDS', 'AGZ', 'CSB', 'FILL', 'LQDI', 'FFIU', 'SOUN', 'OSS',
           'NMTC', 'SPOFF']
# List of stock symbols
start_date = '2024-02-14'  # Start date of the investment
end_date = '2024-02-16'  # Target date for the investment's value calculation

total_value, preantege = calculate_total_value(symbols, start_date, end_date)
print(f"Total value of the account move by {end_date}: ${total_value:.2f}, "
      f"preantege: %{preantege}")
